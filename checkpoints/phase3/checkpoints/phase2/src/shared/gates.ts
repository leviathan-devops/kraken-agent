...
export const GATE_CRITERIA: Record<GateName, GateCriteria> = {
  ...
  verify: {
    gate: 'verify',
    blockingCriteria: [
      'SHARK CONTAINER TEST: Container test suite passed (96%+ success)',
      'All subsystems operational',
      'Identity system functional',
      'Triple-brain concurrency verified',
      'Firewall patterns blocking correctly',
    ],
    evidenceRequired: ['ContainerTestResult.json', 'TestResults.xml'],
  },
  test: {
    gate: 'test',
    blockingCriteria: [
      'TRIDENT REVIEW: Code review passed (0 critical/high)',
      'SPEC.md alignment verified',
      'No theatrical code',
      'No weak assertions',
      'Error handling complete',
    ],
    evidenceRequired: ['TridentReport.json', 'VerificationReport.json'],
  },
  audit: {
    gate: 'audit',
    blockingCriteria: [
